...
## DarkPlasma_CancelText.js

ゲーム終了ウィンドウ及びショップコマンドのキャンセルテキストを設定するプラグイン

キャンセルのキャンセル問題に悩まされるあなたへ
...
## DarkPlasma_MagicalHitRate.js

魔法攻撃の命中率を物理攻撃の命中率に影響されるようにするプラグイン
...
## DarkPlasma_MessageRows.js

メッセージウィンドウの大きさを行数で指定するプラグイン
